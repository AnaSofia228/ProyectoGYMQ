...
import Ingresar from '../../LoginRegister/Ingresar'
    ...
    <div>
        ...
        <nav className='nav'>
            <ul className='main-links'>
                ...
                <li className='dropdown-li' style={{backgroundColor: '#E5F513', height: '1rem'}}><Link className='links' style={{color: 'black'}}>Tienda</Link></li>
            </ul>
            <ul className='icons'>
                <li>
